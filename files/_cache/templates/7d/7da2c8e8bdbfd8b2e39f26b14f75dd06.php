...
class __TwigTemplate_fbe2559c26219c3d93b2e4f12b40e331 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 40
        if ( !(is_string($__internal_compile_0 = ($context["anchor"] ?? null)) && is_string($__internal_compile_1 = "Log_") && ('' === $__internal_compile_1 || 0 === strpos($__internal_compile_0, $__internal_compile_1)))) {
            // line 41
            echo "    ";
            // line 42
            echo "    ";
