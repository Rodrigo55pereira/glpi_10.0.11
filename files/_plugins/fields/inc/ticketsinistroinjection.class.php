...
class PluginFieldsTicketsinistroInjection extends PluginFieldsTicketsinistro implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Ticket::getTypeName() . " - Sinistro";
   }
